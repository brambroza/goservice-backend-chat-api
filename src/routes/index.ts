...
import { verifyFacebookSignature, verifyLineSignature, verifyThirdPartySignature } from '../middleware/signature';
...
export function registerRoutes(app: Express, config: AppConfig, logger: Logger) {
  ...
  const controller = new WebhookController(
    new LineService(lineClient, logger, kafkaClient, rabbitClient, redisClient),
